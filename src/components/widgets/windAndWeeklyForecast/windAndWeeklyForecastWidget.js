...
const WindAndWeeklyForecastWidget = ({ currentConditionIcon, currentCondition, windSpeed, windDirection, rain, hourlyForecast, weeklyForecast }) => {
    console.log("weqwpe", weeklyForecast)
    return <div className="widget wind_and_weekly_widget">
